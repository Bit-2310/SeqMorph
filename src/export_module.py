...
class ExportHandler:
    ...
    def export_sequence(sequence, mutated_sequence, output_file, sequence_name="Sequence"):
        ...
        try:
            ...
            sequence_type = GeneUtils.detect_sequence_type(sequence)
            ...
            if sequence_type in ["DNA", "RNA"]:
                gc_content = GeneUtils.gc_content(sequence)
                nucleotide_frequency = GeneUtils.nucleotide_frequency(sequence)
                ambiguity_count = GeneUtils.count_ambiguities(sequence)
            ...
            with open(output_file, "w") as f:
                ...
                if ambiguity_count is not None:
                    f.write(f"Ambiguity Count: {ambiguity_count}\n")
